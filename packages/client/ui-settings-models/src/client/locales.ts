...
export const en = {
  ...
  opencodeLogin: 'Import from opencode login',
  opencodeLoginBusy: 'Importing…',
  opencodeLoginDone: 'Imported the opencode account credential into the harness (OPENCODE_ZEN_API_KEY).',
  opencodeLoginPresent: 'An OPENCODE_ZEN_API_KEY credential is already configured.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  opencodeLogin: '从 opencode 登录导入',
  opencodeLoginBusy: '导入中…',
  opencodeLoginDone: '已把 opencode 账号凭据导入 harness（OPENCODE_ZEN_API_KEY）。',
  opencodeLoginPresent: '已配置 OPENCODE_ZEN_API_KEY 凭据。',
