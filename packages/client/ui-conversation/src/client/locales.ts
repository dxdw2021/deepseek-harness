...
export const zh = {
  ...
  'access.confirm.description': '启用完全访问权限后，agent 将减少确认步骤，并且可以直接执行更多操作，包括敏感操作、文件修改或外部命令。仅建议在你信任当前任务时使用。',
  ...
  'message.turnError.enospc': '磁盘空间不足，无法写入',
  'message.turnError.streamClosed': '流连接中断，未收到完成信号',
  'message.turnError.rateLimit': '请求频率过高，请稍后重试',
  'message.turnError.server': '服务器错误',
  'message.turnError.transport': '网络连接异常',
  'message.turnError.timeout': '请求超时',
  'message.turnError.auth': 'API 密钥无效',
  'message.turnError.aborted': '请求已取消',
  'message.turnError.emptyResponse': '服务器返回空响应',
  'message.turnError.malformedResponse': '服务器响应格式错误',
  'message.turnError.unsupportedContent': '不支持的内容类型',
  'message.turnError.unsupportedOption': '不支持的选项',
  'message.turnError.invalidAdapter': '适配器配置错误',
  'message.turnError.invalidDirectory': '目录配置错误',
  'message.turnError.invalidDiscovery': '发现配置错误',
  'message.turnError.invalidCatalog': '目录数据错误',
  'message.turnError.invalidPreparedCall': '预调用配置错误',
  'message.turnError.noAdapter': '未找到适配器',
  'message.turnError.noDiscovery': '未找到发现服务',
  'message.turnError.duplicateAdapter': '重复的适配器注册',
  'message.turnError.duplicateDirectory': '重复的目录配置',
  'message.turnError.duplicateDiscovery': '重复的发现服务注册',
  'message.turnError.registrationDisposed': '注册已失效',
  'message.turnError.invalidReplayState': '重放状态无效',
  'message.turnError.discoveryFailed': '模型发现失败',
  'message.turnError.unknownModel': '未知模型',
  'message.turnError.noAdapterForProvider': '未找到该提供商的适配器',
  'message.turnError.noModelForProvider': '该提供商无此模型配置',
  'message.turnError.contextWindowExceeded': '输入内容超出模型上下文窗口限制',
  'message.turnError.quotaExceeded': '账户配额或余额已用尽',
  'message.turnError.invalidCredential': '凭证格式错误，请检查 API 密钥',
  'message.running': '深度思考中…',
...
export const en = {
  ...
  'message.turnError.enospc': 'No space left on device',
  'message.turnError.streamClosed': 'Stream interrupted without completion signal',
  'message.turnError.rateLimit': 'Rate limit exceeded, please try again later',
  'message.turnError.server': 'Server error',
  'message.turnError.transport': 'Network connection error',
  'message.turnError.timeout': 'Request timed out',
  'message.turnError.auth': 'API key is invalid',
  'message.turnError.aborted': 'Request was cancelled',
  'message.turnError.emptyResponse': 'Server returned empty response',
  'message.turnError.malformedResponse': 'Server response format error',
  'message.turnError.unsupportedContent': 'Unsupported content type',
  'message.turnError.unsupportedOption': 'Unsupported option',
  'message.turnError.invalidAdapter': 'Adapter configuration error',
  'message.turnError.invalidDirectory': 'Directory configuration error',
  'message.turnError.invalidDiscovery': 'Discovery configuration error',
  'message.turnError.invalidCatalog': 'Catalog data error',
  'message.turnError.invalidPreparedCall': 'Prepared call configuration error',
  'message.turnError.noAdapter': 'No adapter found',
  'message.turnError.noDiscovery': 'No discovery service found',
  'message.turnError.duplicateAdapter': 'Duplicate adapter registration',
  'message.turnError.duplicateDirectory': 'Duplicate directory configuration',
  'message.turnError.duplicateDiscovery': 'Duplicate discovery service registration',
  'message.turnError.registrationDisposed': 'Registration has been disposed',
  'message.turnError.invalidReplayState': 'Invalid replay state',
  'message.turnError.discoveryFailed': 'Model discovery failed',
  'message.turnError.unknownModel': 'Unknown model',
  'message.turnError.noAdapterForProvider': 'No adapter found for this provider',
  'message.turnError.noModelForProvider': 'No model configured for this provider',
  'message.turnError.contextWindowExceeded': 'Input exceeds model context window limit',
  'message.turnError.quotaExceeded': 'Account quota or balance exhausted',
  'message.turnError.invalidCredential': 'Invalid credential format, please check your API key',
  'message.running': 'Deep diving…',
